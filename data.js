...
const GROUPS = [
  ...
  {
    id: 'blackpink', name: 'BLACKPINK', generation: 3, colors: ['#FFD6E0', '#FF9EB5'],
    members: [
      { id: 'jisoo', name: '智秀', stats: { dance:'B+', vocal:'A', rap:'C+', visual:'S', fanservice:'A+', variety:'A+', language:'B', bond:'S' } },
      { id: 'jennie', name: 'Jennie', stats: { dance:'A+', vocal:'A+', rap:'S', visual:'S', fanservice:'A', variety:'A', language:'S', bond:'A+' } },
      { id: 'rose', name: 'Rosé', stats: { dance:'A', vocal:'S', rap:'B', visual:'A', fanservice:'A+', variety:'B+', language:'S', bond:'A+' } },
      { id: 'lisa', name: 'Lisa', stats: { dance:'S', vocal:'B+', rap:'S', visual:'S', fanservice:'A+', variety:'A+', language:'S', bond:'A+' } },
    ],
  },
  {
    id: 'exo', name: 'EXO', generation: 3, colors: ['#D6E8FF', '#A8C8F0'],
    members: [
      { id: 'xiumin', name: '秀珉', stats: { dance:'A', vocal:'A', rap:'C+', visual:'A', fanservice:'A', variety:'A', language:'B', bond:'A+' } },
      { id: 'suho', name: 'SUHO', stats: { dance:'B+', vocal:'A', rap:'C+', visual:'A', fanservice:'A+', variety:'A', language:'A', bond:'S' } },
      { id: 'baekhyun', name: '伯贤', stats: { dance:'A', vocal:'S', rap:'B', visual:'A', fanservice:'S', variety:'A+', language:'B', bond:'A+' } },
      { id: 'chen', name: 'CHEN', stats: { dance:'B+', vocal:'S', rap:'C+', visual:'B+', fanservice:'A', variety:'A', language:'A', bond:'A+' } },
      { id: 'chanyeol', name: '灿烈', stats: { dance:'B+', vocal:'A', rap:'A+', visual:'S', fanservice:'A+', variety:'A+', language:'A', bond:'A+' } },
      { id: 'do', name: 'D.O.', stats: { dance:'B+', vocal:'S', rap:'C+', visual:'A', fanservice:'A', variety:'B+', language:'B', bond:'A+' } },
      { id: 'kai', name: 'Kai', stats: { dance:'S', vocal:'B+', rap:'C+', visual:'S', fanservice:'A+', variety:'A', language:'B', bond:'A+' } },
      { id: 'sehun', name: '世勋', stats: { dance:'A', vocal:'B+', rap:'A', visual:'S', fanservice:'A', variety:'B+', language:'B', bond:'A+' } },
    ],
  },
  {
    id: 'nctdream', name: 'NCT DREAM', generation: 3, colors: ['#D6FFE8', '#A8E8C8'],
    members: [
      { id: 'dreammark', name: 'Mark', stats: { dance:'A+', vocal:'B+', rap:'S', visual:'A', fanservice:'A+', variety:'A', language:'S', bond:'A+' } },
      { id: 'renjun', name: '仁俊', stats: { dance:'A', vocal:'A+', rap:'B', visual:'A', fanservice:'A', variety:'A+', language:'S', bond:'A+' } },
      { id: 'jeno', name: 'Jeno', stats: { dance:'A+', vocal:'B+', rap:'A', visual:'A', fanservice:'A', variety:'B+', language:'B', bond:'A+' } },
      { id: 'dreamhaechan', name: '楷灿', stats: { dance:'A', vocal:'A+', rap:'B', visual:'A', fanservice:'A+', variety:'S', language:'B+', bond:'A+' } },
      { id: 'jaemin', name: '渽民', stats: { dance:'B+', vocal:'B+', rap:'A', visual:'S', fanservice:'A+', variety:'B+', language:'B', bond:'A+' } },
      { id: 'chenle', name: '辰乐', stats: { dance:'B+', vocal:'S', rap:'C+', visual:'A', fanservice:'A+', variety:'A+', language:'S', bond:'A+' } },
      { id: 'jisung', name: '志晟', stats: { dance:'S', vocal:'B+', rap:'B', visual:'A', fanservice:'A', variety:'B+', language:'B', bond:'A+' } },
    ],
  },
  {
    id: 'ateez', name: 'ATEEZ', generation: 4, colors: ['#FFF3D6', '#FFD9A8'],
    members: [
      { id: 'hongjoong', name: '弘中', stats: { dance:'A', vocal:'A', rap:'S', visual:'A', fanservice:'A+', variety:'A+', language:'B+', bond:'S' } },
      { id: 'seonghwa', name: '星和', stats: { dance:'A', vocal:'A', rap:'B', visual:'S', fanservice:'A+', variety:'A', language:'B', bond:'A+' } },
      { id: 'yunho', name: '润浩', stats: { dance:'S', vocal:'A', rap:'B', visual:'A', fanservice:'A+', variety:'A+', language:'B', bond:'A+' } },
      { id: 'yeosang', name: '吕尚', stats: { dance:'A', vocal:'B+', rap:'B', visual:'S', fanservice:'A', variety:'A', language:'B', bond:'A+' } },
      { id: 'san', name: '伞', stats: { dance:'S', vocal:'A', rap:'B', visual:'A', fanservice:'S', variety:'A', language:'B', bond:'A+' } },
      { id: 'mingi', name: '旼琦', stats: { dance:'A+', vocal:'B+', rap:'S', visual:'A', fanservice:'A', variety:'A', language:'B', bond:'A+' } },
      { id: 'wooyoung', name: '友荣', stats: { dance:'A+', vocal:'A', rap:'B', visual:'A', fanservice:'S', variety:'A+', language:'B', bond:'A+' } },
      { id: 'jongho', name: '钟浩', stats: { dance:'B+', vocal:'S', rap:'B', visual:'A', fanservice:'A', variety:'B+', language:'B', bond:'A+' } },
    ],
  },
  {
    id: 'riize', name: 'RIIZE', generation: 5, colors: ['#E8D6FF', '#C9A8F0'],
    members: [
      { id: 'shotaro', name: '将太郎', stats: { dance:'S', vocal:'B+', rap:'B', visual:'A', fanservice:'A+', variety:'A', language:'A', bond:'A+' } },
      { id: 'eunseok', name: '恩石', stats: { dance:'B+', vocal:'A', rap:'B', visual:'S', fanservice:'A', variety:'B+', language:'B+', bond:'A+' } },
      { id: 'sungchan', name: '成灿', stats: { dance:'A', vocal:'B+', rap:'A', visual:'S', fanservice:'A+', variety:'A+', language:'B+', bond:'A+' } },
      { id: 'wonbin', name: '元彬', stats: { dance:'A', vocal:'B+', rap:'B', visual:'S', fanservice:'A', variety:'B+', language:'B', bond:'A+' } },
      { id: 'sohee', name: '昭熙', stats: { dance:'A', vocal:'S', rap:'C+', visual:'A', fanservice:'A+', variety:'A', language:'B+', bond:'A+' } },
      { id: 'anton', name: 'Anton', stats: { dance:'B+', vocal:'A', rap:'B', visual:'A', fanservice:'A', variety:'B+', language:'S', bond:'A+' } },
    ],
  },
  {
    id: 'treasure', name: 'TREASURE', generation: 4, colors: ['#FFE8D6', '#FFC9A8'],
    members: [
      { id: 'hyunsuk', name: '崔玹硕', stats: { dance:'A', vocal:'B+', rap:'S', visual:'A', fanservice:'A', variety:'A+', language:'B', bond:'S' } },
      { id: 'jihoon', name: '志焄', stats: { dance:'A+', vocal:'A', rap:'B', visual:'A', fanservice:'A+', variety:'S', language:'B', bond:'S' } },
      { id: 'yoshi', name: 'Yoshi', stats: { dance:'A', vocal:'B+', rap:'S', visual:'A', fanservice:'A', variety:'B+', language:'A', bond:'A+' } },
      { id: 'junkyu', name: '俊奎', stats: { dance:'B+', vocal:'S', rap:'B', visual:'A', fanservice:'A+', variety:'A+', language:'B+', bond:'A+' } },
      { id: 'yoonjaehyuk', name: '尹材赫', stats: { dance:'B+', vocal:'B+', rap:'B', visual:'A', fanservice:'A', variety:'A', language:'B', bond:'A+' } },
      { id: 'asahi', name: 'Asahi', stats: { dance:'B+', vocal:'A', rap:'A', visual:'A', fanservice:'A', variety:'B+', language:'A', bond:'A+' } },
      { id: 'tdoyoung', name: '道荣', stats: { dance:'A', vocal:'A', rap:'B', visual:'A', fanservice:'A+', variety:'A', language:'B', bond:'A+' } },
      { id: 'haruto', name: 'Haruto', stats: { dance:'A', vocal:'B+', rap:'S', visual:'A', fanservice:'A', variety:'B+', language:'A', bond:'A+' } },
      { id: 'jeongwoo', name: '朴炡禹', stats: { dance:'B+', vocal:'S', rap:'C+', visual:'A', fanservice:'A', variety:'B+', language:'B', bond:'A+' } },
      { id: 'junghwan', name: '苏庭焕', stats: { dance:'A+', vocal:'B+', rap:'C+', visual:'A', fanservice:'A+', variety:'A', language:'B', bond:'A+' } },
    ],
  },
  {
    id: 'illit', name: 'ILLIT', generation: 5, colors: ['#FFD6F0', '#FF9EC8'],
    members: [
      { id: 'yunah', name: '玧我', stats: { dance:'A', vocal:'A', rap:'B', visual:'A', fanservice:'A', variety:'A+', language:'B+', bond:'A+' } },
      { id: 'minju', name: '慜柱', stats: { dance:'B+', vocal:'A+', rap:'B', visual:'S', fanservice:'A', variety:'B+', language:'B', bond:'A+' } },
      { id: 'moka', name: 'Moka', stats: { dance:'A+', vocal:'B+', rap:'B', visual:'A', fanservice:'A+', variety:'B+', language:'A', bond:'A+' } },
      { id: 'wonhee', name: '沅禧', stats: { dance:'B+', vocal:'A', rap:'C+', visual:'A', fanservice:'S', variety:'A+', language:'B', bond:'A+' } },
      { id: 'iroha', name: 'Iroha', stats: { dance:'S', vocal:'B+', rap:'B', visual:'A', fanservice:'A', variety:'B+', language:'A', bond:'A+' } },
    ],
  },
  {
    id: 'kiiikii', name: 'KiiiKiii', generation: 5, colors: ['#F5D6FF', '#E0A8F0'],
    members: [
      { id: 'jiyu', name: '智旴', stats: { dance:'A', vocal:'A+', rap:'B', visual:'A', fanservice:'A', variety:'A', language:'B', bond:'A+' } },
      { id: 'leesol', name: '利率', stats: { dance:'A+', vocal:'A', rap:'B', visual:'A', fanservice:'A+', variety:'B+', language:'B', bond:'A+' } },
      { id: 'sui', name: '秀伊', stats: { dance:'A', vocal:'S', rap:'B', visual:'A', fanservice:'A', variety:'B+', language:'B', bond:'A+' } },
      { id: 'haum', name: '荷芸', stats: { dance:'A+', vocal:'A', rap:'A', visual:'A', fanservice:'A', variety:'A', language:'B', bond:'A+' } },
      { id: 'kya', name: 'Kya', stats: { dance:'A', vocal:'B+', rap:'A+', visual:'A', fanservice:'A', variety:'A+', language:'A', bond:'A+' } },
    ],
  },
  {
    id: 'hearts2hearts', name: 'Hearts2Hearts', generation: 5, colors: ['#D6FFF6', '#A8F0E0'],
    members: [
      { id: 'carmen', name: 'Carmen', stats: { dance:'A', vocal:'A', rap:'B', visual:'A', fanservice:'A', variety:'B+', language:'S', bond:'A+' } },
      { id: 'jiwoo', name: '志祐', stats: { dance:'A+', vocal:'A+', rap:'B', visual:'A', fanservice:'A', variety:'B+', language:'B', bond:'A+' } },
      { id: 'yuha', name: '柔河', stats: { dance:'A', vocal:'A', rap:'B', visual:'A', fanservice:'A+', variety:'B+', language:'A', bond:'A+' } },
      { id: 'stella', name: 'Stella', stats: { dance:'A', vocal:'A+', rap:'B', visual:'S', fanservice:'A', variety:'B+', language:'S', bond:'A+' } },
      { id: 'juun', name: '主娫', stats: { dance:'A+', vocal:'A', rap:'B', visual:'A', fanservice:'A+', variety:'A', language:'A', bond:'A+' } },
      { id: 'ana', name: 'A-na', stats: { dance:'A+', vocal:'A', rap:'B', visual:'A', fanservice:'A', variety:'B+', language:'S', bond:'A+' } },
      { id: 'ian', name: 'Ian', stats: { dance:'A', vocal:'A+', rap:'B', visual:'A', fanservice:'A', variety:'A', language:'A', bond:'A+' } },
      { id: 'yeon', name: '誉温', stats: { dance:'A', vocal:'A', rap:'B', visual:'A', fanservice:'A', variety:'B+', language:'A', bond:'A+' } },
    ],
  },
  {
    id: 'fiftyfifty', name: 'FIFTY FIFTY', generation: 5, colors: ['#E4E0FF', '#B8B0F0'],
    members: [
      { id: 'keena', name: 'Keena', stats: { dance:'B+', vocal:'B+', rap:'S', visual:'A', fanservice:'A+', variety:'A', language:'A', bond:'A+' } },
      { id: 'chanelle', name: 'Chanelle', stats: { dance:'A', vocal:'S', rap:'B', visual:'A', fanservice:'A+', variety:'A', language:'S', bond:'A+' } },
      { id: 'yewon', name: '艺源', stats: { dance:'A', vocal:'A', rap:'C+', visual:'A', fanservice:'A', variety:'A', language:'A', bond:'A+' } },
      { id: 'hana', name: '荷娜', stats: { dance:'A+', vocal:'B+', rap:'B', visual:'A', fanservice:'A', variety:'B+', language:'A', bond:'A+' } },
      { id: 'athena', name: 'Athena', stats: { dance:'A', vocal:'A', rap:'B', visual:'A', fanservice:'A+', variety:'B+', language:'S', bond:'A+' } },
    ],
  },
];
